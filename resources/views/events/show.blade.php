...
<body
    ...
    <div class="w-full h-full backdrop-brightness-50 bg-gray-900/60 absolute top-0">
        <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            ...
            <div id="profile"
                ...
                <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <h1 class="text-3xl font-bold pt-8 lg:pt-0">{{ $event->name }} <span
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><i
