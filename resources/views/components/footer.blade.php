            ...
            <div class="lg:col-span-7">
                ...
                <div class="grid sm:grid-cols-2 gap-y-8 gap-x-12">
                    <div class="group flex gap-4">
                        <div class="flex-shrink-0 w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center border border-slate-800 group-hover:border-amber-500 group-hover:bg-amber-500/10 transition-all duration-300">
